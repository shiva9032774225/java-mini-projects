...
public class A2 {
		...
		switch(choise) {
		 case 1:
		    	 String q="insert into information (reser_id,holder_name,room_num,contact_num) values(?,?,?,?);";
		...
		case 2:
		 		...
		 		String q1="select * from information;";
		...
		case 3:
		 		...
		 		sc.nextLine();
		 		String h="select * from information where holder_name=? and reser_id=?";
		...
		case 4:
		 		...
		 		case 1:
		 			...
		 			String n=sc.next();
		 			sc.nextLine();
		 			String q3="update information set holder_name=? where reser_id=?;";
		 		...
		 		case 2:
		 			...
		 			String roll=sc.next();
		 			String q4="update information set room_num=? where reser_id=?;";
		 		...
		 		case 3:
		 			...
		 			String num=sc.next();
		 			String q5="update information set contact_num=? where reser_id=?;";
		...
		case 5:
		     	...
		     	int std=sc.nextInt();
		     	sc.nextLine();
		     	String q6="delete from information where reser_id=?;";
